            ...
            <table id="current-offers-table" class="min-w-full divide-y divide-slate-200 text-sm bootstrap-table" style="background:#fff; min-width: 900px;">
                <thead class="bg-slate-50">
                    <tr class="text-left text-xs font-medium uppercase tracking-wide text-slate-500">
                        <th class="px-4 py-3 cursor-pointer select-none" onclick="sortTable(0, 'current-offers-table')">ID <x-ui.icon name="arrows-sort" size="xs" class="text-slate-400" /></th>
                        <th class="px-4 py-3 cursor-pointer select-none" onclick="sortTable(1, 'current-offers-table')">{!! trans('Tour Name') !!} <x-ui.icon name="arrows-sort" size="xs" class="text-slate-400" /></th>
                        <th class="px-4 py-3 cursor-pointer select-none" onclick="sortTable(2, 'current-offers-table')">{!! trans('City') !!} <x-ui.icon name="arrows-sort" size="xs" class="text-slate-400" /></th>
                        <th class="px-4 py-3 cursor-pointer select-none" onclick="sortTable(3, 'current-offers-table')">{!! trans('Status') !!} <x-ui.icon name="arrows-sort" size="xs" class="text-slate-400" /></th>
                        <th class="px-4 py-3 cursor-pointer select-none" onclick="sortTable(4, 'current-offers-table')">{!! trans('Departure Date') !!} <x-ui.icon name="arrows-sort" size="xs" class="text-slate-400" /></th>
                        <th class="px-4 py-3 cursor-pointer select-none" onclick="sortTable(5, 'current-offers-table')">{!! trans('Return Date') !!} <x-ui.icon name="arrows-sort" size="xs" class="text-slate-400" /></th>
                        <th class="px-4 py-3 cursor-pointer select-none" onclick="sortTable(6, 'current-offers-table')">{!! trans('PAX') !!} <x-ui.icon name="arrows-sort" size="xs" class="text-slate-400" /></th>
                        <th class="px-4 py-3 cursor-pointer select-none" onclick="sortTable(7, 'current-offers-table')">{!! trans('Created At') !!} <x-ui.icon name="arrows-sort" size="xs" class="text-slate-400" /></th>
