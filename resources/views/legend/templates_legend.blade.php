      <div id="legend_help" style=" z-index:9999; position: absolute;top:-20px;width:350px; right: -100%; background-color: rgb(255, 255, 255);opacity: 0;">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-sm-12"><h2>{!!trans('main.EmailTemplates')!!}</h2><hr></div>
                            </div>

                            <div class="row top" >
                                <div class="col-sm-3" >
                                    <button class="btn btn-success btn-xs" style="margin-left: 16px;" >{!!trans('main.New')!!}</button>
                                </div>
                                <div class="col-sm-9"><p>{!!trans('main.AddTemplatenameand')!!}</p>
                                        <small></small>
                                </div>
                            </div>
                            ...
                            <div class="row" >
                                ...
                                <div class="col-sm-9"><p>{!!trans('main.EditTemplatenameandcontent')!!}</p>
                                    <small></small>
                                </div>
                            </div>
                            ...
                            <div class="row" >
                                ...
                                <div class="col-sm-9"><p>{!!trans('main.ConfirmremovalofTemplateforever')!!}</p>
                                    <small></small>
                                </div>
                            </div>
                            ...
                            <div class="row align-self-center" style="margin-bottom: 16px;" >
                                <div class="col-sm-12 text-center">
                                    <span > {!!trans('main.Availabletags')!!}</span>
                                </div>
                            ...
                            <div class="row bottom"  >
                                <div class="col-sm-12">
                                    <small style="margin-left: 16px;">{!!trans('main.Thetagswillbereplaced')!!}</small>
                                </div>
