            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="javascript:history.back()" class="btn btn-ghost-secondary">
                        <i class="ti ti-arrow-left me-1"></i><?php echo e(trans('main.Back')); ?>

                    </a>
                    <button type="button" class="btn btn-success saved">
                        <i class="ti ti-device-floppy me-1"></i><?php echo e(trans('main.Save')); ?>
        ...
        <div class="card-header">
            ...
            <div class="card-actions">
                <a href="#" class="namesToggle hideTitle btn btn-sm btn-outline-secondary">
                    <i class="ti ti-eye me-1"></i><?php echo e(trans('main.Showtitles')); ?>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-8">
                    <div class="hide validate-name">
                        <span class="text-danger"><i class="ti ti-alert-circle me-1"></i><?php echo e(trans('main.Nameisrequiredfield')); ?></span>
                    </div>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('scaffold-interface.layouts.tabler-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamppp\htdocs\dev-eetstravel\resources\views/quotation/create.blade.php ENDPATH**/ ?>