    ...
    <div class="box-body">
        ...
        <table class="table table-striped table-hover clickable-rows" style='background:#fff'>
            ...
            <?php $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="clickable-row" onclick="window.location.href='<?php echo e(route('announcements.show', ['announcement' => $announcement->id])); ?>'">
                    ...
                    <td onclick="event.stopPropagation();">
                        <div class="btn-list flex-nowrap">
                            <!-- EDIT BUTTON -->
                            <a href="<?php echo e(route('announcements.edit', ['announcement' => $announcement->id])); ?>" class="btn btn-icon btn-ghost-warning" title="Edit">
                            ...
                            <button type="button" class="btn btn-icon btn-ghost-danger delete-btn"
                                    data-url="<?php echo e(route('announcements.destroy', ['announcement' => $announcement->id])); ?>"
                                    title="Delete"
        ...
        <div class="box-footer clearfix">
            ...
            <a href="<?php echo e(route('announcements.index')); ?>" class="btn btn-outline-secondary float-end">
...
</style><?php /**PATH D:\xamppp\htdocs\dev-eetstravel\resources\views/scaffold-interface/dashboard/components/announcements_list.blade.php ENDPATH**/ ?>