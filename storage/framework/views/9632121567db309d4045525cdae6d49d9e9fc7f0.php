...
<?php $__env->startSection('content'); ?>
   ...
   ['title' => 'Comment', 'sub_title' => "{$comment->serviceName()}",
   'breadcrumbs' => [
        ...
        <div class="box box-success" style="position: relative; left: 0px; top: 0px;">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="margin_button">
                            ...
                            <a href="<?php echo route('comment.edit', $comment->id); ?>">
            ...
            <div class="box-footer">
                <form method='POST' action='<?php echo e(route('comment.store')); ?>' enctype="multipart/form-data" id="form_comment">
                    ...
                    <input type="text" id="parent_comment" hidden name="parent" value="<?php echo e($comment->id); ?>">
                    <input type="text" id="default_reference_id" hidden name="reference_id" value="<?php echo e($comment->reference_id); ?>">
                    <input type="text" id="default_reference_type" hidden name="reference_type" value="<?php echo e($comment->reference_type); ?>">
                    <input type="text" id="id_comment" hidden name="id_comment" value="<?php echo e($comment->id); ?>">

                    <button type="submit" class="btn btn-success pull-right" id="btn_send_comment" style="margin-top: 5px;">Send</button>
                </form>
            </div>
        </div>
    </section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('scaffold-interface.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/comments/show.blade.php ENDPATH**/ ?>