        ...
        <div class="box box-solid" >
            ...
            <div class="box-header with-border">
                @if(Auth::user()->can('tour_package.create'))
                    ...
                    <button class="btn btn-flat btn-success pull-right add-description-package" onclick=loadDescriptionemplate()>{!!trans('main.Adddescription')!!}</button>
                @endif
            ...
            <form id="form_transfer_buses_drivers">
				...
				<div class="form-group">
                    ...
                    <div class="input-group">
                        {!! Form::text('pickup_des', '', ['class' => 'form-control',
                         'id' => 'pickup_des']) !!}
                    </div>
				...
				<div class="form-group">
                    ...
                    <label for="departure_date">{!!trans('Drop Destination')!!}</label>

                    <div class="input-group">
                        {!! Form::text('drop_des', '', ['class' => 'form-control',
                         'id' => 'drop_des']) !!}
                    </div>
