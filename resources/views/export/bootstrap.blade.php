@if (isset($isDoc) and $isDoc)
    ...
    header('content-disposition: attachment;filename=' . $download_name . 'docx');
    ?>
@endif
...
<hr>
        ...
        <div class="row">
            <div class="col-sm-12 nopadding">
                    ...
                    <tbody>
                        @foreach ($tourDays as $tourDay)
                            ...
                            <tr class=''>
                                ...
                                <td colspan="3" class='' width="86%" align="left" valign="top">
                                    <h3 class="text_color" style="">&nbsp;&nbsp;Day {{ $countDay }} -
                            ...
                            @foreach ($tourDay->packages as $package)
                                @if ($package->itn == 1)
                                    <tr class='border_table'>
                                        ...
                                        <td class='border_table'  width="100px"align="center">
                                            {{ $item->name }} </td>
                        ...
                        <td class='border_table'>
                            @if ($package->description_package)
                                ...
                                @foreach ($lines as $line)
                                    ...
                                    @endphp
                                    @if (strlen($line) < 75)
                                        <span class="text_color" style="margin-left: 500px">
                                            {{ $line }}
                                        </span>
                                        <br>
                                    @else
                                        ...
                                        <span class="text_color" style="margin-right:20px">
                                           &nbsp;&nbsp; {!! $subline !!}
                                        </span>
                                        <br>
                                        <?php
                ...
                <table class='border_table' width="80%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                        <tr>
                            <td  class='border_table' width="10%" align="right"></td>
                            <td  class='border_table' width="12%" align="center"></td>
                            <td  class='border_table' width="50%" height="42" align="left" valign="top">
                                @endif
                                @endforeach
                                @endif
								...
								<span class="text_color col-sm-offset-2 "> {!!  $package->description !!} 
                                            </span>
								@endif
								--}}
                                <?php
                                ...
                                @if ($srv)
                                    @if ($srv->work_phone)
                                        ...
                                        @if ($srv->address_first)
                                            ...
                                            </span>&nbsp;&nbsp;{!! $srv->address_first . ' ' . $srv->address_second . ' ' . $city_name . ' ' . $country_name !!} <br>
                                            &nbsp;&nbsp;<span class="text_color"> {!! trans('Zip/Postal Code') !!}:
                                            </span>&nbsp;&nbsp;{!! $srv->code !!} <br>
                                        @endif
                                        <br>
                                    @endif
