...
@section('content')
   ...
   ['title' => 'Office Earnings', 'sub_title' => 'Office Earnings Create',
   'breadcrumbs' => [
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box box-body border_top_none">
                ...
                @endif
                <form method='POST' action='{{route('office_earning.store')}}' enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="revenue" name="revenue" type="text" class="form-control" value="{{old('revenue')}}">
                                </div>

                                <div class="form-group">
                                    <label for="Profit">{!!trans('Profit')!!}</label>
                                    <input id="profit" name="profit" type="text" class="form-control" value="{{old('Profit')}}">
                                </div>
