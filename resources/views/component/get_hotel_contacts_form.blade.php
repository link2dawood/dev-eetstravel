    ...
    @foreach($hotelContacts as $item)
        <div class="item-contact">
            ...
            <div class="form-group">
                ...
                <input id="contact_full_name" name="contacts[{{$item->count}}][contact_full_name]" type="text" class="form-control"
            ...
            <div class="form-group col-md-6 col-lg-6" style="padding-left: 0">
                ...
                <input id="contact_mobile_phone" name="contacts[{{$item->count}}][contact_mobile_phone]" type="text" class="form-control"
            ...
            <div class="form-group col-md-6 col-lg-6" style="padding-right: 0">
                ...
                <input id="contact_work_phone" name="contacts[{{$item->count}}][contact_work_phone]" type="text" class="form-control"
                       value="{{ $item->work_phone }}">
            </div>
            <div class="form-group">
                <label for="contact_email">{!!trans('main.Email')!!}</label>
                <input id="contact_email" name="contacts[{{$item->count}}][contact_email]" type="text" class="form-control"
                       value="{{ $item->email }}">
            </div>
        </div>
    @endforeach
