...
<form method="POST" action="{!! url('room_types') !!}" enctype="multipart/form-data" class="space-y-4">
    ...
    <div class="rounded border border-slate-200 bg-white">
        ...
        <div class="px-5 py-5 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                <label class="block text-xs font-medium uppercase tracking-wide text-slate-500 mb-1">{{ trans('main.Code') }} <span class="text-danger-600">*</span></label>
            ...
            <div>
                <label class="block text-xs font-medium uppercase tracking-wide text-slate-500 mb-1">{{ trans('Image') }} <span class="text-danger-600">*</span></label>
