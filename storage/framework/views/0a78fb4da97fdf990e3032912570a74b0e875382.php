...
<section class="content">
	<h1>
        <?php echo trans('main.ShowTourPackage'); ?>
    ...
    <table class = 'table table-bordered'>
        ...
        <tbody>
            <tr>
                <td>
                    <b><i><?php echo trans('Name'); ?>: </i></b>
                </td>
                <td><?php echo $tour_package->name; ?></td>
            </tr>
            <tr>
                <td>
                    <b><i><?php echo trans('Description'); ?>: </i></b>
                </td>
                <td><?php echo $tour_package->description; ?></td>
            </tr>
            
        </tbody>
    </table>

    <span id="default_reference_id" data-info="<?php echo e($tour_package->id); ?>"></span>
    <span id="default_reference_type" data-info="<?php echo e(\App\Comment::$services['tour_package']); ?>"></span>
    <span id="default_token_val" data-info="<?php echo e(csrf_token()); ?>"></span>
    <div id="commentContainer">

    </div>
				</div>	
			
			<?php if($tour_package->service()->service_type == 'Hotel'): ?>
				<tr>
                <td>
                    <b><i><?php echo trans('Supplier Url'); ?>: </i></b>
                </td>
				<td><a href =<?php echo $tour_package->supplier_url."/".$tour_package->id; ?> >Go to  Supplier Page</a></td>
            	</tr>
				<div class = "row" style = "margin:10px">
				<div id="tour_create" class = "col-md-1">
                    <?php echo \App\Helper\PermissionHelper::getCreateButton(route('offers.create',$tour_package->id), \App\Tour::class); ?>

                </div>
					<div class = "col-md-1">
				<a class='btn btn-success' href= "<?php echo e(route('offers.emails',$tour_package->id)); ?>" ><?php echo trans('Offer Emails'); ?></a>
								  </div>
				</div>
				<div class ="">
					<h1>Hotel Offers</h1>
					 <?php $__currentLoopData = $tour_package->hotel_offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <thead>
                    <th>ID</th>
					<th style="width: 104px;"><?php echo trans('Offer Status'); ?></th>
                    <th style="width: 104px;"><?php echo trans('Supplier Status'); ?></th>
						<?php
											$printedRoomNames = [];
										?>
										...
										<?php $__currentLoopData = $selected_room_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $selected_room_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php if(!in_array($selected_room_type->name, $printedRoomNames)): ?>
												<th class="rooms-title"><?php echo e($selected_room_type->name); ?></th>
												<?php
					...
					<th><?php echo trans('City Tax'); ?></th>
                    <th><?php echo trans('Halfboard Supp p.p'); ?></th>
						
					<th><?php echo trans('foc'); ?></th>
                    <th><?php echo trans('Max per group'); ?></th>
					<th><?php echo trans('Portrage pp'); ?></th>
					<th><?php echo trans('Hotel File'); ?></th>
					<th><?php echo trans('Hotel Note'); ?></th>
...
<script>
        ...
        let table = $('#offers-table').DataTable({
            ...
            pageLength: 50,
            ajax: {
                url: "<?php echo e(route('offers_data',[$tour_package->id,0])); ?>",
            },
            columns: [
				{data: 'id', name: 'id'},
				...
				<?php $__currentLoopData = $selected_room_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $selected_room_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                { "data": "<?php echo e($selected_room_type->code); ?>" },
            	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			  ...
			  },
            {
                ...
                'createdCell':  function (td, cellData, rowData, row, col) {
					console.log(td);
                    var url = "<?php echo e(url('offer/updatestatus')); ?>/" + rowData.id;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('scaffold-interface.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/tour_package/offers/index.blade.php ENDPATH**/ ?>