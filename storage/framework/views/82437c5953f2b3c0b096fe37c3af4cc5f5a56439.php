                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="story_points" id="story_points" class="form-control" value="<?php echo e(old('story_points', 0)); ?>" min="0" max="100">
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('scaffold-interface.layouts.tabler-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/task/create.blade.php ENDPATH**/ ?>