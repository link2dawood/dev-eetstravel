...
class StoreTourRequest extends FormRequest
{
    ...
    {
        return true; // Allow authenticated users to create tours
    }
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            // Business Dates
            'invoice' => 'nullable|date|after_or_equal:departure_date',
            'ga' => 'nullable|date',
    ...
    public function messages()
    {
        return [
            ...
            'external_name.unique' => 'This external name is already taken.',
