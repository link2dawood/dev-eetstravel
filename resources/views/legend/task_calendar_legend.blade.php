      <div id="legend_help" style="z-index:500; position: absolute;top:30px;width:500px; left: -20px; right: -100%; background-color: rgb(255, 255, 255);opacity: 0;"  data-mode="1" >
                        ...
                        <div class="container-fluid">
                            <div class="row line_br">
                                <div class="col-sm-12"><h2>{!!trans('main.TaskCalendar')!!}</h2><hr></div>
                            </div>
							...
							<div class="row">								
								<div class="col-sm-4">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row line_br">
                                            ...
                                            <div class="col-sm-8"><button class="btn btn-xs centered" type="button">{!!trans('main.Holidays')!!}</button></div>
                                        </div>
                                        ...
                                        <div class="row bottom">
                                            ...
                                            <div class="col-sm-8"><p>{!!trans('main.Checklistforselecting')!!}</p>
                                                <small></small>
                                            </div>
                                        </div>
								...
								<div class="col-sm-8 ">
                                    ...
                                    <div class="row line_br" >
                                        <div class="col-sm-5" >
                                            <button class="btn btn-xs" style="">{!!trans('main.today')!!}</button>
                                            <button class="btn btn-xs" style="">{!!trans('main.month')!!}</button><br>
                                            <button class="btn btn-xs" style="margin-top: 8px;"><</button>
                                            <button class="btn btn-xs" style="margin-top: 8px;">></button>

                                            <button class="btn btn-xs" style="margin-top: 8px;" >{!!trans('main.day')!!}</button>
                                        </div>
                                        <div class="col-sm-7 ">
                                            <p>{!!trans('main.Dateperiodnavigation')!!}</p>
                                            <small></small>
                                            </span>
                                        </div>
                                    </div>
...
{{--                                            <div class="col-sm-7"><p>{!!trans('main.TaskwithTour')!!}</p>--}}
{{--                                                <small></small>--}}
{{--                                            </div>--}}
                                        </div>
...
{{--                                            <div class="col-sm-7"><p>{!!trans('main.TaskwithoutTour')!!}</p>--}}
{{--                                                <small></small>--}}
{{--                                            </div>--}}
                                        </div>
                                        ...
                                        <div class="row bottom">
                                            ...
                                            <div class="col-sm-12" >
                                                <small >
                                                    ...
                                                    {!!trans('main.YoucanclickontheTasktoeditit')!!}</small>
                                            </div>
                                        </div>
