		...
		<div class="box box-body border_top_none">
			...
			<form action="<?php echo e(url('/users/'.$user->id)); ?>" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="email" name="email" value="<?php echo e($errors != null && count($errors) > 0 ? old('email') : $user->email); ?>" class="form-control" required>
				</div>

				<div class="form-group">
					<label for=""><?php echo e(trans('main.Name')); ?></label>
					<input type="text" name="name" value="<?php echo e($errors != null && count($errors) > 0 ? old('name') : $user->name); ?>" class="form-control" required>
				</div>
				...
				<div class="form-group">
					<label for=""><?php echo e(trans('main.Education')); ?></label>
					<input type="text" name="education" value="<?php echo e($errors != null && count($errors) > 0 ? old('education') : $user->education); ?>" class="form-control" placeholder="Education">
				</div>

				<div class="form-group">
					<label for=""><?php echo e(trans('main.Location')); ?></label>
					<input type="text" name="location" value="<?php echo e($errors != null && count($errors) > 0 ? old('location') : $user->location); ?>" class="form-control" placeholder="Location">
				</div>

				<div class="form-group">
					<label for=""><?php echo e(trans('main.Note')); ?></label>
					<input type="text" name="note" value="<?php echo e($errors != null && count($errors) > 0 ? old('note') : $user->note); ?>" class="form-control" placeholder="Note">
				</div>
                ...
                <div class="form-group">
                    ...
                    <div style="margin-bottom: 10px;">
                        <?php if($user->avatar): ?>
                            <img src="<?php echo e(asset($user->avatar)); ?>" alt="Current Avatar" style="max-width: 150px; height: auto; border-radius: 50%;">
                        <?php else: ?>
                            <img src="<?php echo e(asset('img/avatar.png')); ?>" alt="Default Avatar" style="max-width: 150px; height: auto; border-radius: 50%;">
                        <?php endif; ?>
                    </div>
					...
					<table class='table'>
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="<?php echo e(url('users/removePermission')); ?>/<?php echo e($user->id); ?>/<?php echo e($key); ?>" class="btn btn-danger btn-sm"><i class="ti ti-trash icon"></i></a></td>
							</tr>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</tbody>
					</table>
...
<?php echo $__env->make('scaffold-interface.layouts.tabler-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/profile/edit.blade.php ENDPATH**/ ?>