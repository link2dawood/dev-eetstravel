...
<x-ui.page-header
    title="New flight"
    description="Add a flight supplier to the catalog."
    :breadcrumbs="[
...
<form action="{{ route('flights.store') }}" method="post" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-3 gap-4">
    @csrf
    ...
    <div class="lg:col-span-2 space-y-4">
        ...
        <div class="rounded border border-slate-200 bg-white">
            <div class="border-b border-slate-200 px-5 py-3 flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-slate-500">Basic flight information.</p>
                </div>
            </div>
            <div class="px-5 py-5 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="time" name="from_time" id="from_time" value="{{ old('from_time', '12:00') }}"
                           class="block w-full h-9 rounded border border-slate-300 bg-white px-3 text-sm text-slate-700 shadow-subtle focus:outline-none focus:ring-2 focus:ring-primary-600/30 focus:border-primary-600" />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="time" name="to_time" id="to_time" value="{{ old('to_time', '13:00') }}"
                           class="block w-full h-9 rounded border border-slate-300 bg-white px-3 text-sm text-slate-700 shadow-subtle focus:outline-none focus:ring-2 focus:ring-primary-600/30 focus:border-primary-600" />
                </div>
                ...
                <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                    @component('component.city_form', [
                        'country_label' => 'country_from', 'country_translation' => 'main.CountryFrom', 'country_default' => 0,
                        'city_label'    => 'city_from',    'city_translation'    => 'main.Cityfrom',    'city_default'    => 0,
                    ])@endcomponent
                </div>
                <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                    @component('component.city_form', [
                        'country_label' => 'country_to', 'country_translation' => 'main.CountryTo', 'country_default' => 0,
        ...
        <div class="rounded border border-slate-200 bg-white">
            <div class="border-b border-slate-200 px-5 py-3 flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-slate-500">Reach the flight supplier directly.</p>
                </div>
            </div>
            <div class="px-5 py-5 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
        ...
        <div class="rounded border border-slate-200 bg-white">
            <div class="border-b border-slate-200 px-5 py-3 flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-slate-500">Attach contracts, schedules, anything related.</p>
                </div>
            </div>
            <div class="px-5 py-5">
        ...
        <div class="sticky bottom-0 -mx-4 sm:mx-0 sm:static sm:rounded sm:border sm:border-slate-200 bg-white sm:bg-slate-50 px-4 sm:px-5 py-3 border-t border-slate-200 sm:border-t-0 sm:border flex items-center justify-end gap-2 shadow-[0_-4px_8px_-4px_rgba(15,23,42,0.05)] sm:shadow-none">
            <x-ui.button as="a" href="{{ route('flights.index') }}" variant="secondary">{!! trans('main.Cancel') !!}</x-ui.button>
