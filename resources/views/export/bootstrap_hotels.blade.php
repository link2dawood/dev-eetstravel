...
<head>
    ...
    <title>{!!trans('main.Hotellist')!!} - {{ $tour->name }}</title>
    <!-- Bootstrap -->
    <style>
        /*!
...
*/
        ...
        .hei {
            /*height: 97%;
            overflow-y: hidden;*/
            /*background-image: url("{{ asset('img/background22.jpg') }}");*/ /*Background image increases processing time in dompdf*/
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 nopadding">
            <h2 class="float-left text_color" style="text-decoration: underline;margin-top: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{!!trans('main.Hotellist')!!}</h2>
        </div>

        <div class="col-sm-6 nopadding ">
		<span class='pull-right' style="padding-top: 50px;padding-right: 60px;padding-bottom: 20px;
										"><img src="{{ public_path() . '/img/eets_logo_small.jpg'}}"></span>
        </div>
        ...
        <div class="col-sm-6">
            ...
            <table  border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td>
						{{ $tour->pax }} 
						@if(count($tour->childrens) > 0)
							+ {{ count($tour->childrens) }} CHD 
							( 
								@foreach($tour->childrens as $index => $chd)
									{{ $chd->age }}{{ $index < count($tour->childrens) - 1 ? ',' : '' }} 
								@endforeach
							) 
						@endif
						@if($tour->pax_free > 0)
                ...
                <tr>
                    ...
                    <td></td>
					 <td ><h4 class="text_color ">{!!trans('main.Room')!!}:</h4></td>
                </tr>
					<tr>
                    ...
                    <td ></td>
					 <td ><h4 class="text_color">T/L:</h4></td>
                </tr>
					<tr>
					 ...
					 <td >
                         ...
                         foreach ($users as $user) {
                             foreach ($tour->users as $t_user) {
                                 if ($user->id == $t_user->id) $selected[] = $user->name;
                             }
                         }
                         ?>
                ...
                @if(count($tourTransfers) > 0)
					...
					<tr>
                        ...
                        <td >
                            ...
                            <h4 class="text_color border_up">Driver:</h4>
                                {{ $driver->name }}
                                <h4 class="text_color"><br>Mobile:</h4>
                    ...
                    <tr>
                        <td ></td>
                        <td ><h4 class="text_color" >{!!trans('main.CoachDetails')!!}:</h4></td>
                    </tr>
					<tr>
						<td ></td>
                        <td >
...
{{--                             @foreach( \App\Status::where('type', 'bus')->get() as $item)
                ...
                @foreach($tourDays as $tourDay)
                    @foreach($tourDay->packages as $package)
                        @if ($package->type == 0 && !$package->description_package)
@if ($package->menus->count())
    {!! (new \Carbon\Carbon($tourDay->date))->formatLocalized('%B %d, %Y (%A)') . ' : ' !!}
    @foreach ($package->menus as $pmenu)
        {{ $pmenu->count }} - {{ $pmenu->menu ? $pmenu->menu->name : '[Menu not found]' }},
    @endforeach
    <br>
@endif
                ...
                @if($menus != '')
                    <tr>
                        <td></td>
                        <td><h4 class="text_color">Meals:</h4></td>
                    </tr>
                    <tr>                            
                        <td></td>
                        <td><div style="width:50%;">{!! $menus !!}</div></td>
                    </tr>
                @endif                 
                </tbody>
            </table>
        ...
        <div class="col-sm-6">
            ...
            <div class="container-fluide">
                <div class="row pull-right">
                    ...
                    <table  width="300px" border="0" cellspacing="0" cellpadding="0" style="background-color: #f3f3f3">
                        <tbody>
                        <tr>
                            <td width="50"></td>
    ...
    <?php $countDay = 0; ?>
{{--
    @if( count($tourTransfers) == 1 || count($tourTransfers) == 0 )
    <br><br><br><br><br><br>
    <br><br><br><br><br><br>
    <br><br><br><br><br>
    @endif
    ...
    @foreach($tourDays as $tourDay)
        <?php $countDay++ ?>
                <tr class="border_table">
                    ...
                    <td width="86%" height="42" align="left" valign="top"></td>
                </tr>
                <tr class="border_table">
                    <td class="border_table" width="13%" align="right"></td>
                    <td class="border_table" width="1%" align="center" valign="" >
                        <img src="img/filled.png" width="11" height="11" /></td>

                    <td class="border_table" height="42" width="86%" align="left" valign=""><h3 class="text_color" style="margin-top: -5px;">&nbsp;&nbsp;Day {{ $countDay }} - {{ (new \Carbon\Carbon($tourDay->date))->formatLocalized('%B %d, %Y (%A)') }}</h3></td>
                </tr>
                @foreach($tourDay->packages as $package)
                    @if ($package->type == 0 && !$package->description_package)
                    <tr>
                        ...
                        <td class="border_table" width="1%" align="center" valign="top" >
                            <img src="img/clear.png" width="11" height="11" style="padding-top:5px;"/>
                        </td>
                        
                        
                        <td class="border_table" align="left" valign="top">
                                <span class="text_color" >
                                    @if($loop->iteration == 1 && $countDay==1)
    {{--
    ...
    --}}                                
                            ...
                            ?>
                            @if( $srv )
                                @if($srv->work_phone)<span class="text_color"> {!!trans('main.Tel')!!}: </span>{{ $srv->work_phone }} @endif @if($srv->work_fax) Fax: {{ $srv->work_fax }} @endif <br>
                                    @if($srv->address_first)<span class="text_color"> {!!trans('main.Address')!!}: </span>{!! $srv->address_first !!} <br> @endif
                              {{--  @if($package->time_from)<span class="text_color"> {!!trans('main.Pickup')!!}: </span>{{ $package->time_from}} <br> @endif
                                @if($package->time_to)<span class="text_color"> {!!trans('main.Dropoff')!!}: </span>{{ $package->time_to }} <br> @endif--}}
