...
<form method="POST" action="{{ route('employes-salary.store') }}" enctype="multipart/form-data" class="space-y-4">
    {{ csrf_field() }}
    ...
    <div class="rounded border border-slate-200 bg-white">
        ...
        <div class="px-5 py-5 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input id="employe_name" name="employe_name" type="text" value="{{ old('employe_name') }}"
            ...
            <div>
                ...
                <input id="employe_salary" name="employe_salary" type="text" value="{{ old('employe_salary') }}"
                       class="form-control block w-full h-9 rounded border border-slate-300 bg-white px-3 text-sm text-slate-700 shadow-subtle focus:outline-none focus:ring-2 focus:ring-primary-600/30 focus:border-primary-600" />
            </div>
            <div>
            ...
            <div>
                ...
                <input id="bonuses" name="bonuses" type="text" value="{{ old('bonuses') }}"
                       class="form-control block w-full h-9 rounded border border-slate-300 bg-white px-3 text-sm text-slate-700 shadow-subtle focus:outline-none focus:ring-2 focus:ring-primary-600/30 focus:border-primary-600" />
            </div>
        </div>
    </div>
