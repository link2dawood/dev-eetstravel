...
class UpdateAnnouncementRequest extends FormRequest
{
    ...
    {
        return true; // Allow authenticated users to update announcements (authorization handled in controller)
    }
    ...
    public function rules()
    {
        return [
            ...
            'remove_files.*' => 'integer|exists:media,id'
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'remove_files.*.exists' => 'One or more files to remove do not exist.'
        ];
    }
