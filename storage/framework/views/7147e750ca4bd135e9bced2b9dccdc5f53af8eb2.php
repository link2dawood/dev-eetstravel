                        ...
                        <div class="item">
                            <div class="chat-details">
                                <span class="chat-author">
                                    by <b><?php echo e(\App\User::find($announcement->author)->name ?? 'Unknown'); ?></b>
                                </span>
                            ...
                            <div class="chat-attachments">
                                <table class="table">
                                    <tbody>
                                        <?php $attachments = $announcement->getMedia('announcement_files'); ?>
                                        <?php if($attachments && $attachments->isNotEmpty()): ?>
                                            <?php $__currentLoopData = $attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="del-container">
                                                    <td class="td_link_attach">
                                                        <div class="td_link_attach__name">
                                                            <a class="name_attach" href="<?php echo e($attachment->getUrl()); ?>" target="_blank">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamppp\htdocs\dev-eetstravel\resources\views/announcements/show_main.blade.php ENDPATH**/ ?>