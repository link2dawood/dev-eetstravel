...
@section('content')
    @include('layouts.title',
       ['title' => 'Currencies', 'sub_title' => 'Currencies Show',
       'breadcrumbs' => [
        ...
        <div class="box box-primary">
            <div class="box-body">
                ...
                <table class = 'table table-bordered'>
                    ...
                    <tr>
                        <td class="show_width_td">
                            <b><i>{!!trans('main.Symbol')!!} : </i></b>
                        </td>
                        <td>{!!$currencies->symbol!!}</td>
                    </tr>
                    <tr>
                        <td class="show_width_td">
                            <b><i>{!!trans('main.Cent')!!} : </i></b>
                        </td>
                        <td>{!!$currencies->cent!!}</td>
                    </tr>
                    <tr>
                        <td class="show_width_td">
                            <b><i>{!!trans('main.SymbolCent')!!}: </i></b>
                        </td>
                        <td>{!!$currencies->symbol_cent!!}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="box box-success" style="position: relative; left: 0px; top: 0px;">
            ...
            <div class="box-footer">
                <form method='POST' action='{{route('comment.store')}}' enctype="multipart/form-data" id="form_comment">
                    ...
                    <input type="text" id="default_reference_id" hidden name="reference_id" value="{{ $currencies->id }}">
                    <input type="text" id="default_reference_type" hidden name="reference_type" value="{{ \App\Comment::$services['currencies']}}">
