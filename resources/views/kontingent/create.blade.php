    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box box-body" style="border-top: none">
                ...
                @endif
                <form method='POST' action='{{route('store_agreements')}}' >
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" value="{{ old('start_date') }}" name="start_date" id="start_date" class="form-control pull-right datepicker"   >
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" value="{{ old('end_date') }}" name="end_date" id="end_date" class="form-control pull-right datepicker"  >
