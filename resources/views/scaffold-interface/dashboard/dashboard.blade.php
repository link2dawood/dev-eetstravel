...
<script src='https://cdn.jsdelivr.net/npm/fullcalendar@6.1.5/index.global.min.js'></script>
    <script src="{{URL::asset('js/jquery-jvectormap-2.0.3.min.js')}}"></script>
    <script src="{{URL::asset('js/jquery-jvectormap-world-mill.js')}}"></script>
    ...
    <script type="text/javascript" src="{{asset('js/lib/chart_tours.js')}}"></script>

 <script src="{{asset('assets/dist/frappe-gantt.js')}}"></script>
