                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="margin_button">
                                ...
                                <button class='btn btn-success' type='submit' id="submitBtn">{!!trans('main.Save')!!}</button>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            {!! Form::text('departure_date', old('departure_date', $tour->departure_date), ['class' => 'form-control pull-right datepicker',
                                             'id' => 'departure_date']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            {!! Form::text('retirement_date', old('retirement_date', $tour->retirement_date), ['class' => 'form-control pull-right datepicker',
                                             'id' => 'retirement_date']) !!}
                                        </div>
                                    </div>
									...
									<div class="form-group" >
										...
										@php $i = 1; @endphp
											...
											<span style="font-size: 18px; margin-right:15px; margin-left:15px; ">{{ $user->name }}
												<input type="checkbox" name="assigned_user[]" id="assigned_user_{{ $user->id }}" value="{{ $user->id }}" {{$user->selected ? 'checked' : ''}}>
											</span>
										<span>|</span>
                                ...
                                <div class="col-md-6">
									...
									@php $i++ @endphp
										<div class="form-group child-field">
												...
												<input type="number" id="price_{{$i}}" name="prices[]" class="form-control" value="{{ old('prices.'.$loop->index, $chd->price) }}">
										</div>
									@endforeach
									@endif
									</div>
                                    ...
                                    <div class="form-group">                                      
                                        <label for="files">{!!trans('main.imageforlanding')!!}</label>
                                        <div>
                                            <div class="file-preview thumbnail">
                                                <div class="file-drop-zone-title" style="padding:15px 10px;">
                                                    ...
                                                    @if($tour->attachments()->first() != null)
                                                        <img class="pic" src="{{ $tour->attachments()->first()->url }}" style="width:100%; max-height: 300px; object-fit: cover;">
                                                    @else
