...
<?php $__env->startSection('content'); ?>
   ...
   ['title' => 'Supplier Invoices', 'sub_title' => 'accounting Show',
   'breadcrumbs' => [
...
<section class="content">
        ...
        <div class="box-body">
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" role='tabpanel' id='info-tab'>
					<input id="invoice_id" type="hidden" name="invoice_id" value ="<?php echo e($invoices->id); ?>">
					<div class="row">
					<div class="col-lg-6">
					<table class = 'table_show table table-bordered'>
                        <tbody>
                       
                        <tr>
                            <td>
                                <b><i><?php echo trans('Due Date'); ?> : </i></b>
                            </td>
                            <td class="info_td_show"><?php echo $invoices->dueDate; ?></td>
                        </tr>
						<tr>
                            <td>
                                <b><i><?php echo trans('Received Date'); ?> : </i></b>
                            </td>
                            <td class="info_td_show"><?php echo $invoices->receivedDate; ?></td>
                        </tr>
                        <tr>
                            <td>
                                <b><i><?php echo trans('Invoice No'); ?> : </i></b>
                            </td>
                            <td class="info_td_show"><?php echo $invoices->invoice_no; ?></td>
                        </tr>
                        </tbody>
                    </table>
					</div>
                    ...
                    <table class = 'table_show table table-bordered'>
                        <tbody>
                        <input id="transaction_id" type="hidden" name="transaction_id" value = <?php echo e($invoices->id); ?>>
                        <tr>
                            <td>
                                <b><i><?php echo trans('Office Name'); ?> : </i></b>
                            </td>
                            <td class="info_td_show"><?php echo e($office->office_name); ?></td>
                        </tr>
                        <tr>
                            <td>
                                <b><i><?php echo trans('Total Price'); ?> : </i></b>
                            </td>
                            <td class="info_td_show"><?php echo e($invoices->total_amount); ?></td>
                        </tr>
							 <tr>
                            <td>
                                <b><i><?php echo trans('Status'); ?> : </i></b>
                            </td>
                            <td class="info_td_show"><?php echo e($invoices->status($invoice_tour)); ?></td>
                        </tr>
                        </tbody>
                    </table>
					</div>
                    ...
                    <table class = 'table_show table table-bordered'>
                        <tbody>
                       		<tr>
                            <td>
                                <b><i><?php echo trans('Tour'); ?> : </i></b>
                            </td>
                            <td class="info_td_show"><?php echo e($invoice_tour->tours->name??""); ?></td>
                        </tr>
							 <tr>
                            <td>
                                <b><i><?php echo trans('Service'); ?> : </i></b>
                            </td>
                            <td class="info_td_show"><?php echo e($invoice_tour->package->name??""); ?></td>
                        </tr>
					...
					<div id="payment_create" style="margin-bottom : 20px;">
                    	<?php echo \App\Helper\PermissionHelper::getCreateButton(route('add_payment',$invoices->id), \App\Invoices::class); ?>
                ...
                <th>Unallocated</th>
                    ...
                    <?php $__env->startComponent('component.files', ['files' => $files, 'invoices' => $invoices]); ?> <?php echo $__env->renderComponent(); ?>
                </div>
                            ...
                            <div class="box-footer">
                                <form method='POST' action='<?php echo e(route('comment.store')); ?>' enctype="multipart/form-data"
                                    ...
                                    <input type="text" id="default_reference_type" hidden name="reference_type"
                                        value="<?php echo e(\App\Comment::$services['invoices']); ?>">
    ...
    <span id="services_name" data-service-name='accounting' data-history-route="<?php echo e(route('services_history', ['id' => $invoices->id])); ?>"></span>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('scaffold-interface.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/invoices/show.blade.php ENDPATH**/ ?>