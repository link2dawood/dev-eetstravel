   ...
   ['title' => 'Edit', 'route' => null]]], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-body">
                <form method='POST' action='<?php echo e(url("tour/{$tour->id}/update")); ?>' enctype="multipart/form-data" id="tour_form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="margin_button">
                                ...
                                <button class='btn btn-success' type='submit' id="submitBtn"><?php echo trans('main.Save'); ?></button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="alert alert-info block-error-driver" style="text-align: center; display: none;"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="name" type="text" class="form-control"
                                               value="<?php echo old('name', $tour->name); ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <?php echo Form::text('departure_date', old('departure_date', $tour->departure_date), ['class' => 'form-control pull-right datepicker',
                                             'id' => 'departure_date']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <?php echo Form::text('retirement_date', old('retirement_date', $tour->retirement_date), ['class' => 'form-control pull-right datepicker',
                                             'id' => 'retirement_date']); ?>
									...
									<div class="form-group" >
										...
										<?php $i = 1; ?>
											...
											<span style="font-size: 18px; margin-right:15px; margin-left:15px; "><?php echo e($user->name); ?>
												...
												<input type="checkbox" name="assigned_user[]" id="assigned_user_<?php echo e($user->id); ?>" value="<?php echo e($user->id); ?>" <?php echo e($user->selected ? 'checked' : ''); ?>>
											</span>
										<span>|</span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="pax" name="pax" type="text" class="form-control"
                                               value="<?php echo old('pax', $tour->pax); ?>">
                                    </div>
									<div class="form-group">
										<label for="child_count">Number of Children:</label>
										<?php if(empty($tour->childrens)): ?>
										<input type="number" id="child_count" name="child_count" class="form-control" value="<?php echo e(old('child_count', 0)); ?>">
										<?php else: ?>
										<input type="number" id="child_count" name="child_count" class="form-control" value="<?php echo e(old('child_count', count($tour->childrens))); ?>">
										<?php endif; ?>
									</div>
									<?php $i = 0; ?>
									...
									<?php $i++ ?>
										<div class="form-group child-field">
												<label for="age_<?php echo e($i); ?>">Age of Child <?php echo e($i); ?>:</label>
												<input type="number" id="age_<?php echo e($i); ?>" name="ages[]" class="form-control" min="0" value="<?php echo e(old('ages.'.$loop->index, $chd->age)); ?>">
												<label for="price_<?php echo e($i); ?>">Price:</label>
												<input type="number" id="price_<?php echo e($i); ?>" name="prices[]" class="form-control" value="<?php echo e(old('prices.'.$loop->index, $chd->price)); ?>">
										</div>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									<?php endif; ?>
									</div>

									<button type="button" onclick="addChildFields()" class="btn btn-primary">Update Child Fields</button>
      						
                                    <div class="form-group">
                                        <label for="pax_free"><?php echo trans('main.PaxFree'); ?></label>
                                        <input id="pax_free" name="pax_free" type="text" class="form-control"
                                               value="<?php echo old('pax_free', $tour->getAttributes()['pax_free']); ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="itinerary"><?php echo trans('main.tourleader'); ?></label>
                                            <?php echo Form::text('itinerary_tl', old('itinerary_tl', $tour->itinerary_tl), ['class' => 'form-control', 'id'=>'itinerary']); ?>

                                    </div>
                                    <div class="form-group">
                                        <label for="phone"><?php echo trans('main.Phone'); ?></label>
                                        <input id="phone" name="phone" type="text" class="form-control"
                                               value="<?php echo old('phone', $tour->phone); ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">                                      
                                        <label for="files"><?php echo trans('main.imageforlanding'); ?></label>
                                        <div>
                                            <div class="file-preview thumbnail">
                                                <div class="file-drop-zone-title" style="padding:15px 10px;">
                                                    <center>Image for landing page</center>
                                                    <?php if($tour->attachments()->first() != null): ?>
                                                        <img class="pic" src="<?php echo e($tour->attachments()->first()->url); ?>" style="width:100%; max-height: 300px; object-fit: cover;">
                                                    <?php else: ?>
                                                        <div style="padding: 50px; background: #f5f5f5; text-align: center;">No image uploaded</div>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group file-caption-main">
                                            <div tabindex="500" class="form-control">
                                                <div class="file-caption-name" id="file-name-display"></div>
                                            </div>
                                            <div class="input-group-btn">
                                                <div tabindex="500" class="btn btn-primary btn-file">
                                                    <i class="glyphicon glyphicon-folder-open"></i>&nbsp;  
                                                    <span class="hidden-xs">Browse …</span>
                                                    <input name="files[]" id="files" class="fileToUpload" type="file" accept="image/*" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>    
...
function addChildFields() {
    ...
    for (var i = 1; i <= count; i++) {
        ...
        div.innerHTML = `
            ...
            <input type="number" id="price_${i}" name="prices[]" class="form-control" step="0.01">
        `;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('scaffold-interface.layouts.tabler-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamppp\htdocs\dev-eetstravel\resources\views/tour/edit.blade.php ENDPATH**/ ?>