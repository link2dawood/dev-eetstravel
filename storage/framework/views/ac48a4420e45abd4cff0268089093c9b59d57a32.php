      <div id="legend_help" style=" z-index:9999; position: absolute;top:-20px;width:350px; right: -100%; background-color: rgb(255, 255, 255);opacity: 0;">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-sm-12"><h2><?php echo trans('main.Tasks'); ?></h2><hr></div>
                            </div>
                            ...
                            <div class="row top" >
                                ...
                                <div class="col-sm-7"><p><?php echo trans('main.AddTaskandconfigure'); ?></p>
                                        <small></small>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7"><p><?php echo trans('main.ShowTaskinfo'); ?></p>
                                    <small></small>
                                </div>
                            </div>
                            ...
                            <div class="row" >
                                ...
                                <div class="col-sm-7"><p><?php echo trans('main.EditTaskparameters'); ?></p>
                                    <small></small>
                                </div>
                            </div>
                            ...
                            <div class="row" >
                                ...
                                <div class="col-sm-7"><p><?php echo trans('main.Confirmremovalof'); ?></p>
                                    <small></small>
                                </div>
                            </div>
                            ...
                            <div class="row line_br" >
                                <div class="col-sm-5" >
                                    <select id="test_select2"  >
                                        <option selected="selected" value="2"><?php echo trans('main.Pending'); ?></option>
                                    </select>
                                </div>
                                <div class="col-sm-7"><p><?php echo trans('main.ChangecurrentTaskstatus'); ?></p>
                                    <small></small>
                                </div>
                            </div>
                            ...
                            <div class="row " >
                                ...
                                <div class="col-sm-7"><p><?php echo trans('main.Searchamongall'); ?></p>
                                    <small> </small>
                                </div>
                            </div>
                            ...
                            <div class="row " >
                                ...
                                <div class="col-sm-7"><p><?php echo trans('main.Taskinhighpriorityorder'); ?></p>
                                    <small></small>
                                </div>
                            </div>
                            ...
                            <div class="row " >
                                ...
                                <div class="col-sm-7"><p><?php echo trans('main.ExportTaskslistCSV'); ?></p>
                                    <small></small>
                                </div>
                            </div>
                            ...
                            <div class="row " >
                                ...
                                <div class="col-sm-7"><p><?php echo trans('main.ExportTaskslistexcel'); ?></p>
                                    <small></small>
                                </div>
                            </div>
                            ...
                            <div class="row bottom" >
                                ...
                                <div class="col-sm-7"><p><?php echo trans('main.ExportTaskslistPDF'); ?></p>
                                    <small></small>
                                </div>
                            </div>
                        </div>
        </div><?php /**PATH /var/www/html/resources/views/legend/task_legend.blade.php ENDPATH**/ ?>