...
<div class="btn-group" role="group">
    <?php if(($permissions['show'] ?? false) && isset($show_route)): ?>
        <a href="<?php echo e($show_route); ?>" class="btn btn-info btn-sm" title="View">
            <i class="fa fa-eye"></i>
        </a>
    <?php endif; ?>

    <?php if(($permissions['edit'] ?? false) && isset($edit_route)): ?>
        <a href="<?php echo e($edit_route); ?>" class="btn btn-warning btn-sm" title="Edit">
            <i class="fa fa-edit"></i>
        </a>
    <?php endif; ?>

    <?php if(($permissions['destroy'] ?? false) && isset($delete_route)): ?>
...
</script><?php /**PATH /var/www/html/resources/views/component/action_buttons.blade.php ENDPATH**/ ?>