        ...
        <div class="box box-primary">
            <div class="box box-body border_top_none">
                ...
                <form method="POST" id="hoteloffers_add_form" class="form-light"
                    action='{!! url('tour_package') !!}/{!! $tour_package->id !!}/offer_update' id="tour_package_add_form"
...
{{--
                            ...
                            <div class="row">
                                <div class="input-wrapper" style="width: 113px;">
                                    <input type="number" class="form-control" id="depositPercentage" min="0">
                                </div>

                                <div class="input-wrapper col-md-4">
                                    <div class="input-group-append">
                                        <select class="form-control form-select" id="depositType">
                                            <option value="percentage">Percentage</option>
                                            <option value="amount">Amount</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="input-wrapper col-md-1">
                                    <label>paid</label>
                                </div>
                                <div class="input-wrapper" style="width: 113px;">

                                    <input type="number" class="form-control" id="deposit_days" min="0">

                                </div>
                                <div class = "col-md-2">days prior to arrival</div>


                            </div>
                            <button type="button" class="btn btn-primary" id="addDeposit">+</button>
                            <div id="depositRequirements">
                            </div>
							--}}
