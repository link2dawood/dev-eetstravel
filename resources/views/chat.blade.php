...
<html>
<head>
    <title>{!!trans('main.RealTimeLaravelwithPusher')!!}</title>
    ...
    <div class="fixed wrapper">
        <ol class="strong" start="2">
            <li>
                ...
                <h2><b>{!!trans('main.RealTimeChat')!!}</b> <small>{!!trans('main.Fundamentalrealtimecommunication')!!}.</small></h2>
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="row light-grey-blue-background chat-app">
            ...
            <div id="messages">
                <div class="time-divide">
                    <span class="date">{!!trans('main.Today')!!}</span>
                </div>
            </div>
...
<script>
    ...
    function sendMessage() {
        ...
        var data = {chat_text: messageText, user:userId};
