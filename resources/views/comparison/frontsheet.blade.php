                                ...
                                <div class="box box-primary">
                                    <div class="box-body">
                                            ...
                                            <div class="col-md-12" style="overflow: auto">
                                                <table class="table table-bordered finder-disable">
                                                    <thead>
                                                        ...
                                                        @foreach ($listRoomsHotel as $room)
                                                        <td @if ($room->room_types->code == 'SIN')
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            $roomPrice = (int)$quotation->getValueByDate($tourDay->date, $room->room_types->code) + (int)$quotation->getValueByDate($tourDay->date, 'DOU') ;
                                                            } else{
                                                            $roomPrice = (int)$quotation->getValueByDate($tourDay->date, $room->room_types->code);
                                                            }

                                                            /* if ($room->room_types->code == 'SIN') {
                                                            $roomPrice = (int)$quotation->getValueByDate($tourDay->date, $room->room_types->code) + (int)$quotation->getValueByDate($tourDay->date, 'DOU') ;
                                                            } else {
                                                            $roomPrice = (int)$quotation->getValueByDate($tourDay->date, $room->room_types->code) ?? 0;
                                                            }
                                                            */
                                                            ...
                                                            @endphp
                                                            <td data-container="body" data-toggle="tooltip" data-placement="bottom" data-original-title="({{$roomPrice}} * {{$roomCount}} * {{$peopleCount}}) = {{ $roomPrice * $roomCount * $peopleCount}}">
                                                            ...
                                                            <td data-container="body" data-toggle="tooltip" data-placement="bottom" data-original-title="({{$roomPrice}} * {{$roomCount}} * {{$peopleCount}}) = {{ $roomPrice * $roomCount * $peopleCount}}">
                                                                ...
                                                                {{--<td>{{$tourDay->firstHotel()->room_types_hotel->find($room->room_type_id)->price}}
                                                            </td>--}}
                                        ...
                                        {{Form::input('text', 'city_tax['.$comparison->comparisonRowByDate($tourDay->date)->id ??''.']', $cityTax, ['class' => 'form-control cityTax city_tax_select'])}} --}}
                                                            ...
                                                            <td data-toggle="tooltip" data-placement="top" title="({{$quotationBudget}} - ({{$realBudget}} + {{$cityTax}})) / {{$tour->pax}}">
                                                                @php
                                                                if ($tour->pax != 0) {
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    <td>
                                                        <h5>{!!trans('main.Finaldocumentssent')!!}</h5>
                                                    </td>
                                                    <td>
                                                        <div class="form-group">
                                                            <div class='input-group date' style="width:150px">
