...
<section class="content">
        ...
        <div class="box-body">
            ...
            <div id="fixed-scroll" class="nav-tabs-custom">
                <ul class="nav nav-tabs" id="fixed-scroll" role='tablist'>
					...
					<li role='presentation'><a href="#office-invoice-tab" aria-controls='office-invoice-tab' role='tab' data-toggle='tab'><?php echo trans('Office Invoice'); ?></a></li>
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" role='tabpanel' id='info-tab'>
                    ...
                    <table class = 'table_show table table-bordered col-lg-6'>
                        <tbody>
                        <input id="office_id" type="hidden" name="office_id" value = <?php echo e($offices->id); ?>>
                        <tr>
                            <td>
                                <b><i><?php echo trans('Office Name'); ?> : </i></b>
                            </td>
                            <td class="info_td_show"><?php echo $offices->office_name; ?></td>
                        </tr>
                        <tr>
                            <td>
                                <b><i><?php echo trans('Office Address'); ?> : </i></b>
                            </td>
                            <td class="info_td_show"><?php echo $offices->office_address; ?></td>
                        </tr>
                        </tbody>
                    </table>
						</div>
                    ...
                    <table class = 'table_show table table-bordered col-lg-6'>
                        ...
                        <tr>
                            <td>
                                <b><i><?php echo trans('Tour Expenses'); ?> : </i></b>
                            </td>
                            <td class="info_td_show"><?php echo $total_tour_expense; ?></td>
                        </tr>
                        <tr>
                            <td>
                                <b><i><?php echo trans('Utility Expenses'); ?> : </i></b>
                            </td>
                            <td class="info_td_show"><?php echo $total_utility_expense; ?></td>
                        </tr>
						<tr>
                            <td>
                                <b><i><?php echo trans('Employee Salaries'); ?> : </i></b>
                            </td>
                            <td class="info_td_show"><?php echo $total_employee_salary; ?></td>
                        </tr>
                        <tr>
                            <td>
                                <b><i><?php echo trans('Office Earnings'); ?> : </i></b>
                            </td>
                            <td class="info_td_show"><?php echo $total_office_earning; ?></td>
                        </tr>
                        <tr>
                            <td>
                                <b><i><?php echo trans('Total B.Amount'); ?> : </i></b>
                            </td>
                            <td class="info_td_show"><?php echo $total_balance; ?></td>
                        </tr>
                        </tbody>
                    </table>
								</div>
                    ...
                    <div id="tour_create" style="float: right;margin:50px 0px 50px 0px">
                        <?php echo \App\Helper\PermissionHelper::getCreateButton(url('tour_expenses/create/'.$offices->id), \App\Tour::class); ?>

                    </div>
					<h3 style=" margin:50px 0px 50px 0px"><?php echo e(trans('TOUR EXPENSES')); ?></h3>
                    ...
                    <div id="tour_create" style="float: right; margin:50px 0px 50px 0px">
                        <?php echo \App\Helper\PermissionHelper::getCreateButton(url('utility_expenses/create/'.$offices->id), \App\Tour::class); ?>

                    </div>
					<h3  style=" margin:50px 0px 50px 0px"><?php echo e(trans('UTILITY EXPENSES')); ?></h3>
            ...
            <div id="tour_create" style="float: right; margin:50px 0px 50px 0px">
                <?php echo \App\Helper\PermissionHelper::getCreateButton(url('employes-salary/create/'.$offices->id), \App\Tour::class); ?>

            </div>
			<h3 style=" margin:50px 0px 50px 0px"><?php echo e(trans('EMPLOYEE SALARY')); ?></h3>
			...
			<div id="tour_create" style="float: right; margin:50px 0px 50px 0px">
                <?php echo \App\Helper\PermissionHelper::getCreateButton(url('office_earning/create/'.$offices->id), \App\Tour::class); ?>

            </div>		
			<h3 style=" margin:50px 0px 50px 0px"><?php echo e(trans('OFFICE EARNINGS')); ?></h3>
            ...
            <div id="office_balance" style="float: right; margin:50px 0px 50px 0px">
                <?php echo \App\Helper\PermissionHelper::getCreateButton(url('office_balance/create/'.$offices->id), \App\Tour::class); ?>

            </div>
			<h3 style=" margin:50px 0px 50px 0px"><?php echo e(trans('OFFICE BALANCES')); ?></h3>
                ...
                <?php echo \App\Helper\PermissionHelper::getCreateButton(url('officeInvoices/create/'.$offices->id), \App\Tour::class); ?>
    ...
    <span id="services_name" data-service-name='accounting' data-history-route="<?php echo e(route('services_history', ['id' => $offices->id])); ?>"></span>
...
<script>
  $(document).ready(function() {
        ...
        let table = $('#tour-expenses-table').DataTable({
            ...
            pageLength: 50,
            ajax: {
				url: `<?php echo e(url('tour_expenses/api/data/${office_id}')); ?>`,
            },
            columns: [{
                    data: 'id',
                    name: 'id'
...
<script>
	  $(document).ready(function() {
        ...
        let table = $('#utility-expenses-table').DataTable({
            ...
            pageLength: 50,
            ajax: {
				url: `<?php echo e(url('utility_expenses/api/data/${office_id}')); ?>`,
            },
            columns: [{
                    data: 'id',
                    name: 'id'
  ...
  $(document).ready(function() {
        ...
        let table = $('#employee-salary-table').DataTable({
            ...
            pageLength: 50,
            ajax: {
				url: `<?php echo e(url('employes-salary/api/data/${office_id}')); ?>`,
            },
            columns: [{
                    data: 'id',
                    name: 'id'
...
<script>
	  $(document).ready(function() {
        ...
        let table = $('#office-earnings-table').DataTable({
            ...
            pageLength: 50,
            ajax: {
				url: `<?php echo e(url('office_earning/api/data/${office_id}')); ?>`,
            },
            columns: [{
                    data: 'id',
                    name: 'id'
...
<script>
	  $(document).ready(function() {
        ...
        let table = $('#office-balances-table').DataTable({
            ...
            pageLength: 50,
            ajax: {
				url: `<?php echo e(url('office_balance/api/data/${office_id}')); ?>`,
            },
            columns: [{
                    data: 'id',
                    name: 'id'
    ...
    $(document).ready(function() {
        ...
        let table = $('#officesinvoice-table').DataTable({
            ...
            pageLength: 50,
            ajax: {
                url: `<?php echo e(url('officeInvoices/api/data/${office_id}')); ?>`,
				//dataSrc: 'data'
            },columns: [
    {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('scaffold-interface.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/office/show.blade.php ENDPATH**/ ?>