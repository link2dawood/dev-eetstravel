...
@foreach($tourDays as $tourDay)
    @foreach($tourDay->packages as $package)
        ...
        @if( $package->reference && $package->type == 0)
            ...
            ?>
        @endif
        <img src="{{ public_path() . '/img/eets_logo_small.jpg'}}" style="margin-top:9px">
        <p style="float: right; margin: 0; padding: 0; top: 0;">
        ...
        <table class="package-table" style="margin-top: 10px;">
            <tbody>
            <tr>
            ...
            <tr>
                ...
                <td>@if(isset($package->service()->service_type)){{$package->service()->service_type}}@endif
				</td>
