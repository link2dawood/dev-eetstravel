...
@section('content')
   ...
   ['title' => 'Tour Expense', 'sub_title' => 'Expense Edit',
   'breadcrumbs' => [
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box box-body border_top_none">
                ...
                @endif
                <form method='POST' action='{{route('tour_expenses.update', ['tour_expense' => $office_tours->id])}}' enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="tour_expenses" name="tour_expenses" type="text" class="form-control" value="{{$office_tours->tour_expenses}}">
                                </div>
                                
                                <div class="form-group">
                                    <label for="Departure_Date">{!!trans('Departure Date')!!}</label>
                                    <input id="tour_departure_date" name="tour_departure_date" type="date" class="form-control" value="{{$office_tours->tour_departure_date}}">
                                </div>
                                <div class="form-group">
                                    <label for="Return_Date">{!!trans('Return Date')!!}</label>
                                    <input id="tour_return_date" name="tour_return_date" type="date" class="form-control" value="{{$office_tours->tour_return_date}}">
                                </div>
