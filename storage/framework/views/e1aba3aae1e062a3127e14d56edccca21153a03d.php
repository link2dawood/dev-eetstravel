    ...
    <?php $__currentLoopData = $childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="item nesting-<?php echo e($nesting); ?>">
            <div class="chat-title
                <?php if($child->id == $announcement->id): ?>
                    active-announcement
                <?php endif; ?>
                    ">
                <h4>
            ...
            <div class="chat-details">
                            <span class="chat-author">
                                by <b><?php echo e(\App\User::find($child->author)->name); ?></b>
                            </span>
            ...
            <?php if(count($child->childs)): ?>
                <?php echo $__env->make('announcements.childs',['childs' => $child->childs, 'nesting' => $nesting+1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
        </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</div><?php /**PATH D:\xamppp\htdocs\dev-eetstravel\resources\views/announcements/childs.blade.php ENDPATH**/ ?>